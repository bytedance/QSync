...
namespace sm70_space{
    using SmArch = cutlass::arch::Sm80; // leave this to pass the compilation. V100 don't have int and tf capability
    using SmArch70 = cutlass::arch::Sm70;
    using SwizzleThreadBlock = cutlass::gemm::threadblock::GemmIdentityThreadblockSwizzle<>;
    constexpr int NumStages = 2;
    // V100 don't have int core
    namespace int4_conv
    {
    ...
    namespace int8_conv
    {
        ...
        // Different for different SM and datatype. Be careful here.
        using ThreadblockShape = cutlass::gemm::GemmShape<128, 64, 64>;  // Threadblock tile shape
        // This code section describes tile size a warp will compute
        using WarpShape = cutlass::gemm::GemmShape<64, 32, 64>;         // Warp tile shape
        // This code section describes the size of MMA op
    ...
    namespace fp_bp_conv_fp16
    {
        ...
        using Conv_Dgrad_Kernel = typename cutlass::conv::kernel::DefaultConv2dDgrad<
            ...
            InstructionShape,
            epilogue_op,
            cutlass::conv::threadblock::StridedDgradIdentityThreadblockSwizzle<4>, // cutlass::gemm::threadblock::GemmSplitKIdentityThreadblockSwizzle<>,
            2,
            cutlass::arch::OpMultiplyAdd,
            cutlass::conv::IteratorAlgorithm::kOptimized,
            cutlass::conv::StrideSupport::kStrided,
