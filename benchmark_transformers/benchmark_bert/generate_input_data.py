...
from QSync import QModule, QProfiler, QProfiler_Trans
from QSync import fp16_fp32agg_hook
from QSync.conf import config as qconfig
from Utils import get_capability
model_name = 'bert'
...
def main():
    ...
    profile_path = os.path.abspath(os.path.join(profile_folder, f"profile_data_{model_name}_{arch_num}.npz"))
    ...
    # model.register_comm_hook(state=None, hook=fp16_fp32agg_hook)
    ...
    from Utils import inp_to_device
    import pickle
    model.train()
    for epoch in range(starting_epoch, args.num_train_epochs):
        ...
        with torch.profiler.profile(
            ...
            for step, batch in enumerate(train_dataloader):
                ...
                root_data_path = os.environ['HOME'] 
                input_data_path = os.path.join(root_data_path, 'analytical_predictor', 'input_data', f"{model_name}_input.pkl")
                input_abs_path = os.path.abspath(input_data_path)
